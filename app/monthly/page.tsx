...
export default async function MonthlyPage() {
  ...
  return <div className="mx-auto max-w-2xl px-4 py-6 sm:px-6 sm:py-8 lg:max-w-3xl"><PageIntro title="月間ランキング" description="今月の打撃成績をOPSでランキング。月初からのデータがたまるほど、月間成績として精度が上がります。" meta={monthly ? `${monthly.year}年 ${monthly.label}・20打席以上` : "月間比較データを蓄積中"} />
